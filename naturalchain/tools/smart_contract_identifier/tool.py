...
def is_proxy(address):
    ...
    # Retrieve the bytecode of the contract
    storage_value = w3.eth.get_storage_at(checksum_address, "0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc").hex()
...
class IdentifyTool(BaseTool):
    ...
    description = "Useful to identify a contract in the Ethereum blockchain. Return wheather is a contract or not and if it's a proxy his implementation address"
