...
def signTransaction(w3, destinationAddress, value, data):
...
class SignTransactionTool(BaseTool):
    ...
    def _run(self, smart_contract_address: str, value: str, data: str, network: NETWORKS) -> str:
        w3 = get_web3(network)
    ...
    async def _arun(self, smartContractAddress: str, value: str, data: str, network: NETWORKS) -> str:
